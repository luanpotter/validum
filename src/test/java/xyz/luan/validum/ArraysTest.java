...
public class ArraysTest extends BaseTestCase {
	...
	public void testArraysSecondLevelAnnotationsInvalid() {
		...
		List<String> errors = validator.validate(god);
		assertListEquals(errors, new String[] { ":powers:Array.lengthBelow{2}", ":powers:[0]:Required.empty", ":weaknesses:Array.lengthAbove{2}",
				":weaknesses:[1]:Required.empty", ":calculationMatrix:Required.empty" });
	}

	@Test
	public void testArraysThirdLevelAnnotationsInvalid() {
		God god = new God(null, new Power[] { Power.FLIGHT, Power.IMMORTALITY }, new ArrayList<Weakness>(), new float[][] { { 2f, 3.5f, 4f, 3.7f },
				{ 2f, 3.7f, 4.1f, 3.2f, 3.2f }, { 4f, 4f, 3.8f, -1f }, { 4f, 4.5f, 3.6f, 3.7f, 0 } }, null);
		List<String> errors = validator.validate(god);
		assertListEquals(errors, new String[] { ":calculationMatrix:Array.lengthDiffers{3}", ":calculationMatrix:[0]:[0]:Numeric.smallerThan{3.5}",
				":calculationMatrix:[1]:Array.lengthDiffers{4}", ":calculationMatrix:[1]:[0]:Numeric.smallerThan{3.5}",
				":calculationMatrix:[1]:[2]:Numeric.greaterThan{4.0}", ":calculationMatrix:[1]:[3]:Numeric.smallerThan{3.5}",
				":calculationMatrix:[1]:[4]:Numeric.smallerThan{3.5}", ":calculationMatrix:[2]:[3]:Numeric.smallerThan{3.5}",
				":calculationMatrix:[3]:Array.lengthDiffers{4}", ":calculationMatrix:[3]:[1]:Numeric.greaterThan{4.0}",
				":calculationMatrix:[3]:[4]:Numeric.smallerThan{3.5}" });
	}

	@Test
	public void testArraysThirdLevelAnnotationsValid() {
		God god = new God(null, new Power[] { Power.FLIGHT, Power.IMMORTALITY }, new ArrayList<Weakness>(), new float[][] { { 3.7f, 3.5f, 4f, 3.641f },
				{ 3.7f, 3.7f, 4.0f, 3.622f }, { 4f, 4f, 3.8f, 3.94f } }, null);
		List<String> errors = validator.validate(god);
	...
	public void testMapFirstLevel() {
		God god = new God(null, new Power[] { Power.FLIGHT, Power.IMMORTALITY }, new ArrayList<Weakness>(), new float[][] { { 3.7f, 3.5f, 4f, 3.641f },
				{ 3.7f, 3.7f, 4.0f, 3.622f }, { 4f, 4f, 3.8f, 3.94f } }, new HashMap<>());
		List<String> errors = validator.validate(god);
	...
	public void testMapSecondLevelWithoutValidator() {
		try {
			...
			Assert.assertEquals("No validator added to this annotation! The annotation @xyz.luan.sabv.customs.PalindromeString() does not have a validator.",
					ex.getMessage());
		}
	}
	...
	public void doTestMapSecondLevel(Validator validator) {
		final float[][] VALID_MATRIX = new float[][] { { 3.7f, 3.5f, 4f, 3.641f }, { 3.7f, 3.7f, 4.0f, 3.622f }, { 4f, 4f, 3.8f, 3.94f } }, INVALID_MATRIX = new float[][] {
				{ 2f, 3.5f, 4f, 3.7f }, { 2f, 3.7f, 4.1f, 3.2f, 3.2f }, { 4f, 4f, 3.8f, -1f }, { 4f, 4.5f, 3.6f, 3.7f, 0 } };
		...
		List<String> errors = validator.validate(god);
		assertListEquals(errors, new String[] { ":secondaryMatrixesByName:[aBA]:xyz.luan.sabv.customs.PalindromeString.notPalindrome",
				":secondaryMatrixesByName:[AABBA]:xyz.luan.sabv.customs.PalindromeString.notPalindrome",
				":secondaryMatrixesByName:[AABBA]:Array.lengthBelow{1}", ":secondaryMatrixesByName:[AABBAA]:[0]:Array.lengthDiffers{3}",
				":secondaryMatrixesByName:[AABBAA]:[0]:[0]:[0]:Numeric.smallerThan{3.5}", ":secondaryMatrixesByName:[AABBAA]:[0]:[1]:Array.lengthDiffers{4}",
				...
				":secondaryMatrixesByName:[AABBAA]:[0]:[2]:[3]:Numeric.smallerThan{3.5}", ":secondaryMatrixesByName:[AABBAA]:[0]:[3]:Array.lengthDiffers{4}",
